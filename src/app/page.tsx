...
export default function LandingPage() {
  return (
    <div className="relative w-full h-screen overflow-hidden text-white font-sans bg-black">
      ...
      {/* Header / Navbar */}
      <header className="absolute top-0 w-full px-8 py-6 z-20 flex items-center justify-between">
        {/* Left: Logo */}
        <motion.div 
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          className="flex items-center gap-2 font-black text-xl tracking-wider w-1/4"
        >
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-pink-500 to-fuchsia-600 flex items-center justify-center shadow-[0_0_15px_rgba(236,72,153,0.5)]">
        ...
        <motion.nav 
          ...
          className="hidden md:flex items-center justify-center gap-10 font-medium text-sm text-white/80 w-2/4"
        >
        ...
        >
          <Link href="/login" className="px-6 py-2 rounded-full border border-white/20 hover:bg-pink-500/20 hover:border-pink-500/50 text-white hover:text-pink-50 transition-all text-sm font-semibold">
            Sign up
          </Link>
        </motion.div>
      </header>
      ...
      {/* Main Content */}
      <main className="relative z-10 w-full h-full flex flex-col justify-center px-8 sm:px-16 lg:px-24">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <h1 className="text-5xl sm:text-6xl md:text-8xl font-black leading-[1.05] tracking-tight mb-6 drop-shadow-2xl font-serif">
          ...
          <p className="text-base md:text-lg text-pink-50/80 mb-10 max-w-lg leading-relaxed drop-shadow-md">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <Link 
              href="/login"
              className="px-10 py-3.5 bg-gradient-to-r from-pink-600 to-fuchsia-600 hover:from-pink-500 hover:to-fuchsia-500 text-white font-bold rounded-lg transition-all shadow-[0_0_30px_rgba(236,72,153,0.4)]"
            >
              Explore
            </Link>
          </div>
